...
load_string_memory:
  pha
  lda startEEPROMData + 0
  sta startRAMData + 0
  lda startEEPROMData + 1
  sta startRAMData + 1
  lda startEEPROMData + 2
  sta startRAMData + 2
  lda startEEPROMData + 3
  sta startRAMData + 3
  lda startEEPROMData + 4
  sta startRAMData + 4
  lda startEEPROMData + 5
  sta startRAMData + 5
  lda startEEPROMData + 6
  sta startRAMData + 6
  pla
  rts
