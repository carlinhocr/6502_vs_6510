...
code = bytearray([
    ...
    0x86, 0x02, 0x60,   #address 6002 is 60 to turn on the 6522 via chip enable and 02 to select data direction register
    ...
    0x86, 0x00, 0x60,   # address 6000 is 60 to turn on the 6522 via chip enable and 0 to select output register
    # turn on 4 pins first one on one off
...
rom = bytearray([0xea] *(32768 - len(code)) )# create an array of 32768 ea
